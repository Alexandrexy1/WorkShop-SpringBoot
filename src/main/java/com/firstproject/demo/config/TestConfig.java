...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order order1 = new Order(null, Instant.parse("2024-07-20T15:50:03Z"), user1);
		Order order2 = new Order(null, Instant.parse("2024-05-17T13:21:22Z"), user1);
		Order order3 = new Order(null, Instant.parse("2024-08-25T20:33:07Z"), user2);
		Order order4 = new Order(null, Instant.parse("2024-09-10T05:43:01Z"), user2);
